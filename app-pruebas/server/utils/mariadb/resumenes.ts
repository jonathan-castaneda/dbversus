...
async function resumenesContarOrdenes(): Promise<number>  {
    ...
    await $fetch('http://localhost:3000/api/mariadb/resumenes/countordenes', {
        method: 'GET',
        headers: {
...
async function resumenesProductos(): Promise<number>  {
    let start = new Date().getTime();
    await $fetch('http://localhost:3000/api/mariadb/resumenes/productosdiarios', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function resumenesProductosFecha(): Promise<number>  {
    ...
    await $fetch('http://localhost:3000/api/mariadb/resumenes/productosdiariosfecha?fecha=' + fecha, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function resumenesTotalDiario() : Promise<number> {
    let start = new Date().getTime();
    await $fetch('http://localhost:3000/api/mariadb/resumenes/totaldiario', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function resumenesTopten(): Promise<number>  {
    let start = new Date().getTime();
    await $fetch('http://localhost:3000/api/mariadb/resumenes/topten', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
