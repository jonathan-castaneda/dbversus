<template>
    <div>
        <div class="row flex flex-center q-mt-md">
            <div class="text-h4">Pruebas para Mongo</div>
            
        </div>
        <div class="row">
            <div class="text-caption col-12 q-ml-md">
                Recuerda que debes tener arrancado el contenedor de Mongo levantado con docker y no debe tener datos, solo debe tener la estructura de las tablas.
                ...
                <p>Recuerda que en el archivo <strong>/mongo/docker-compose.yml</strong> defines la memoria y el CPU asignado al contenedor para las pruebas</p>
            </div>
        ...
        <div class="row q-ml-lg q-mt-md">
            <q-table
            flat bordered
            title="Pruebas sobre Gestor Mongo"
            :rows="rows"
            :columns="columns"
            color="primary"
            row-key="name"
